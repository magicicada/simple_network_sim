...
def build_args(argv, inputFilesFolder="sample_input_files"):
    ...
    parser.add_argument(
        ...
        default=sampledir / "scrc_compartmentTransitionByAge.csv",
        help="Epidemiological rate parameters for movement within the compartmental model - SCRC standard model structure, rates are sample, not correct.",
    )
    parser.add_argument(
        "--population",
